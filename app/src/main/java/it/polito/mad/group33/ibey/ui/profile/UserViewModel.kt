...
//                val updatedUser = User(user.value?.fullName!!,user.value?.nickname!!,user.value?.email!!,user.value?.phoneNumber!!,user.value?.location!!)
//                updatedUser.uid = userId
//                updatedUser.fullName = document.getString("fullName") ?: ""
//                updatedUser.nickname = document.getString("nickname") ?: ""
//                updatedUser.phoneNumber = document.getString("phoneNumber") ?: ""
//                updatedUser.location = getLocationFromDocument(document)
//                updatedUser.totRate = 10.0//document.getDouble("totRate")?:0.0
//                updatedUser.rateCount = 3//document.getLong("rateCount")?:-1
//                user.value = updatedUser.copy()
         }
